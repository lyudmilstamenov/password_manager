...
SUCCESSFULLY_CREATED_ACCOUNT_MESSAGE = 'Account with {} was successfully created.' + ENTER_COMMAND_WITH_USER_MESSAGE
DELETED_ACCOUNT_MESSAGE = 'Account with account name {} was successfully deleted.' + ENTER_COMMAND_WITH_USER_MESSAGE
UPDATED_ACCOUNT_MESSAGE = 'Account with {} was successfully updated.' + ENTER_COMMAND_WITH_USER_MESSAGE
...
COPIED_TO_CLIPBOARD_MESSAGE = 'The password was successfully copied to your clipboard.' + ENTER_COMMAND_WITH_USER_MESSAGE
SHOW_PWD_MESSAGE = 'Your password is {}.' + ENTER_COMMAND_WITH_USER_MESSAGE
INVALID_PASSWORD_MESSAGE = 'Invalid password. The password should contain at least 6 characters, 1 uppercase letters, ' \
