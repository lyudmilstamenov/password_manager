...
DELETED_CATEGORY_MESSAGE = 'Category with category name {} was successfully deleted.' \
                           + ENTER_COMMAND_WITH_USER_MESSAGE
REMOVE_CATEGORY_QUESTION_MESSAGE = 'There are accounts who are part of this category. ' \
                                   'Are you sure that you want to delete the category?[yes/no]'
