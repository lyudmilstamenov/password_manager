...
class TestAccountHelpers:
    ...
    def test_retrieve_account_by_account_name__without_last_account(self, mocker):
        ...
        mocker.patch('src.server.helpers.account_helpers.check_account_exists', return_value=[{'account_name': 'name'}])
    ...
    def test_retrieve_account_by_account_name__with_last_account_with_different_name(self, mocker):
        ...
        mocker.patch('src.server.helpers.account_helpers.check_account_exists', return_value=[{'account_name': 'name2'}])
    ...
    def test_retrieve_account_by_account_name(self, mocker):
        ...
        mocker.patch('src.server.helpers.account_helpers.check_account_exists', return_value=[{}])
    ...
    def test_retrieve_account_by_account_name__throws_value_error(self, mocker):
        app = App()
        owner = type('obj', (object,), {'key': 'value'})()
        mocker.patch('src.server.helpers.account_helpers.check_account_exists', return_value=None)
    ...
    def test_retrieve_account_password(self, mocker):
        owner = Owner()
        owner.key = 'value'
        mocker.patch('src.server.helpers.account_helpers.retrieve_account_by_account_name', return_value={'password': 'pwd2'})
        mocker.patch('src.server.helpers.account_helpers.decrypt', return_value='decrypted')
    ...
    def test_update_account_info(self, mocker):
        mocker.patch('src.server.helpers.account_helpers.populate_account_info',
                     return_value={'account_name': '-del', 'password': 'password2', 'category': None})
        mocker.patch('src.server.helpers.account_helpers.encrypt', return_value='pwd')
    ...
    def test_populate_account_info(self, mocker):
        ...
        mocker.patch('src.server.helpers.account_helpers.validate_entity_name', return_value='account name')
        mocker.patch('src.server.helpers.account_helpers.validate_string_property', return_value='str')
        mocker.patch('src.server.helpers.account_helpers.validate_url', return_value='url')
        mocker.patch('src.server.helpers.account_helpers.validate_email', return_value='em@gmail.com')
        mocker.patch('src.server.helpers.account_helpers.validate_password', return_value='strong_pwd')
        mocker.patch('src.server.helpers.account_helpers.input', return_value=next(inputs))
        mocker.patch('src.server.helpers.account_helpers.getpass', return_value=next(inputs))
